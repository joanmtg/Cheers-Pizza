 ...
 * @author Joan
 */
public class VentanaReporteIngresosMes extends javax.swing.JFrame {

    JFrame ventanaAnterior;
    Empleado empleadoActual;
    
    public VentanaReporteIngresosMes(JFrame ventana, Empleado empleado) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaReporteIngresosMes(null, null).setVisible(true);
            }
        });
    }
